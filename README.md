...
<head>
  ...
  <style>
    body {
      background-image: url("pha.bac.jpeg");
...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-5">
        <img src="pha.jpg" class="img-fluid" alt="Pharmacy Image" width="2000" height="2500">
      </div>
      <div class="col-md-4">
        <img src="ph_2.jpg" class="img-fluid" alt="Pharmacy Image" width="2000" height="2000">
      </div>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany -NAVEEN KUMAR (212223220067) All rights reserved.</p>
  </footer>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="pro.3.jpeg" class="card-img-top" alt="Product 1">
            <div class="card-body">
          ...
          <div class="card">
            <img src="prod.1.jpg" class="card-img-top" alt="Product 2">
            <div class="card-body">
          ...
          <div class="card">
            <img src="prod.1.webp" class="card-img-top" alt="Product 3">
            <div class="card-body">
...
<head>
  ...
  <style>
    body {
      background-image: url("pha.back.avif");
      background-size: cover;
      background-repeat: no-repeat;
      font-size: 19px;
    }
...
product.html:
![alt text](<naveen/pharmaapp/static/Screenshot (154).png>)

about.html:
![alt text](<naveen/pharmaapp/static/Screenshot (155).png>)


contact.html:
![alt text](<naveen/pharmaapp/static/Screenshot (156) - Copy.png>)
